...
<div class="container">
  ...
  <div class="btn-group">
    ...
    <!--  
    <select name="category" class="btn btn-style-one" style="height:45px">
    	<option value="#">카테고리별 내역 보기</option>
    	<option value="입금" onclick="category('1')">입금</option>
    	<option value="이체" onclick="category('2')">이체</option>
    	<option value="식비" onclick="category('3')">식비</option>
    	<option value="카페,간식" onclick="category('4')">카페,간식</option>
    	<option value="편의점,마트" onclick="category('5')">편의점,마트</option>
    	<option value="술,유흥" onclick="category('6')">술,유흥</option>
    	<option value="술,유흥" onclick="category('7')">쇼핑</option>
    	<option value="술,유흥" onclick="category('8')">취미,여가</option>
    	<option value="술,유흥" onclick="category('9')">미용</option>
    	<option value="술,유흥" onclick="category('10')">주거,통신</option>
    </select>
    -->
