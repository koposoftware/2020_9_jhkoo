...
<script>
	$(document).ready(function(){
		$('#goMonthAgo').click(function(){
			
			$.ajax({
				url : '${ pageContext.request.contextPath}/goMonthAgo/${depositAccount.accountNumber}',
				type : 'get',
				success : function(data){
					...
					$(list).each(function(){
						...
						str +=       "<td>" + this.toName + "</td>";
						str +=       "<td>" + this.logTypeKey + "</td>";
...
<div class="container">
  ...
  <div class="btn-group">
    ...
    <button type="button" class="btn btn-style-one" id="goMonthAgo">이전 달 내역</button>
